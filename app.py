...
def update_output(contents, filename):
    if contents is not None:
        ...
        if 'xlsx' in filename:
            ...
            splot.update_layout({'plot_bgcolor': 'rgba(0, 0, 0, 0)', 'paper_bgcolor': 'rgba(0, 0, 0, 0)'}, font=dict(size=18), margin=dict(l=50, r=100, t=50, b=50), bargap=0.2, bargroupgap=0.2)
